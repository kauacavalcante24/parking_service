...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "img/logo_new_edit.png",
    ...
    "site_icon": "img/logo_new_icon_edit.png",

    # Welcome text on the login screen
    "welcome_sign": "Bem-vindo ao Sistema de Gestão do Estacionamento!",

    # Copyright on the footer
    "copyright": "@kauacavalcante24",
    ...
    "icons": {
        ...
        "vehicles.VehicleBrand": "fa-solid fa-folder-closed",
        "vehicles.VehicleType": "fa-solid fa-folder-closed",
