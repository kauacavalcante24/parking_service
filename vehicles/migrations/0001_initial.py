    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vehicles_brand', to='vehicles.vehiclebrand', verbose_name='Marca')),
                ('vehicle_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vehicles_type', to='vehicles.vehicletype', verbose_name='Tipo de Veículo')),
            ],
            options={
